...
<html lang="pt">
    ...
    <head>
        ...
        <title>LISTA ESTUDANTES MATRICULADOS</title>
    ...
    <table class="table table-stripeds" style="">
        <thead>
            ...
            <tr style="background-color: #3F51B5;color: #ffffff;">
                <th colspan="8" style="padding: 5px;">LISTA ESTUDANTES MATRICULADOS</th>
            </tr>
                        
            <tr style="background-color: #a1a4b9;color: #ffffff;">
                <th colspan="3" style="padding: 5px;">Ano Lectivo:</th>
                <th colspan="5" style="padding: 5px;">{{ $ano ? $ano->Designacao : 'Todos' }}</th>
            </tr>
            
            <tr style="background-color: #a1a4b9;color: #ffffff;">
                <th colspan="3" style="padding: 5px;">Graduação:</th>
                <th colspan="5" style="padding: 5px;">{{ $candidatura ? $candidatura->designacao : 'Todos' }}</th>
            </tr>            
            
            <tr style="background-color: #a1a4b9;color: #ffffff;">
                <th colspan="3" style="padding: 5px;">Curso:</th>
                <th colspan="5" style="padding: 5px;">{{ $curso ? $curso->Designacao : 'Todos' }}</th>
            </tr>
            
            <tr style="background-color: #a1a4b9;color: #ffffff;">
                <th colspan="3" style="padding: 5px;">Turno:</th>
                <th colspan="5" style="padding: 5px;">{{ $turno ?  $turno->Designacao : 'Todos' }}</th>
            </tr>
            
            <tr style="background-color: #a1a4b9;color: #ffffff;">
                <th colspan="3" style="padding: 5px;">Total de DE REGISTOS:</th>
                <th colspan="5" style="padding: 5px;">{{ count($estudantes) }}</th>
            </tr>
            ...
            <tr style="background-color: #3F51B5;color: #ffffff">
                ...
                <th style="text-align: center;padding: 4px 0">Telefone</th>
                <th style="text-align: center;padding: 4px 0">Gênero</th>
                <th style="text-align: center;padding: 4px 0">Curso</th>
                <th style="text-align: center;padding: 4px 0">Ano De Ingresso</th>
            </tr>
        </thead>
        @php
            $contador = 0;
