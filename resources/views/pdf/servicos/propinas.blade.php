    ...
    <table class="table table-stripeds" style="">
        <thead style="border-bottom: 1px solid #000;">
            <tr style="background-color: #3F51B5;color: #ffffff">
                ...
                <th style="padding: 7px 2px;text-align: center">Codigo</th>
                <th style="padding: 7px 2px;text-align: center;width: 300px">Descrição</th>
                <th style="padding: 7px 2px;text-align: center">Polo</th>
                <th style="text-align: right;padding: 7px 2px;width: 200px">Preço</th>
            </tr>
        </thead>
        @php
            $contador = 0;
        ...
        <tbody>
            @foreach ($servicos as $item)
                ...
                <tr>
                    ...
                    <td style="padding: 7px 2px;text-align: center">{{ $item->Descricao }}</td>
                    <td style="padding: 7px 2px;text-align: center">{{ $item->polo->designacao }}</td>
