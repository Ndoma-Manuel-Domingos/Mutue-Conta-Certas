    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">LISTAGEM DE TIPOS DE PROVEITOS</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="/tipos-proveitos">Dashboard</a>
                            </li>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="/tipos-proveitos/create" class="btn btn-info btn-sm mx-1">
                                    <i class="fas fa-plus"></i> CRIAR TIPO DE PROVEITOS</a>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover" id="tabela_de_tipos_creditos">
                                    ...
                                    <tbody>
                                        <tr v-for="item in tipos_proveitos" :key="item">
                                            <td>#</td>
                                            <td>{{ item.id }}</td>
                                            <td>{{ item.designacao }}</td>
                                            <td>
                                                <div class="float-right">
                                                    <a :href="`/tipos-proveitos/${item.id}/edit`"
...
export default {
    ...
    methods: {
        updateData() {
            this.$Progress.start();
            this.$inertia.get("/tipos-proveitos", this.params, {
                preserveState: true,
                preverseScroll: true,
                onSuccess: () => {
        ...
        ExportarExcelTipoProveito() {
            window.open(
                `exportar-tipo-proveito-excel`
            );
        },
