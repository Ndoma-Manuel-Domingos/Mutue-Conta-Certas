    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">CRIAR TIPO DE PROVEITOS</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/tipos-proveitos">Listagem</a></li>
                            <li class="breadcrumb-item active">Criar tipo de Proveito</li>
                        </ol>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post(route('tipos-proveitos.store'), this.form)
                .then((response) => {
