  ...
  <MainLayouts>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">CRIAR DIÁRIOS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/diarios">Listagem</a></li>
              <li class="breadcrumb-item active">Criar Diários</li>
            </ol>
          </div>
        </div>
      </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                          ...
                          <input type="text" id="numero" v-model="form.numero" class="form-control" placeholder="Ex: 11">
...
export default {
  ...
  methods: {
    submit() {
      ...
      axios.post(route('diarios.store'), this.form)
        .then((response) => {
          // this.form.reset();
