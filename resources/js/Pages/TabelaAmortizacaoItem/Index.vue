  ...
  <MainLayouts>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">TABELA DE AMORTIZAÇÕES ITEMS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/tabela-amortizacoes-items">Dashboard</a></li>
          ...
          <div class="col-12 col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <a href="/tabela-amortizacoes-items/create" class="btn btn-sm btn-info mx-1">
                    <i class="fas fa-plus"></i> CRIAR ITEM DE AMORTIZAÇÕES</a
                  >
