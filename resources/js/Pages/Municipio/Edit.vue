                    ...
                    <div class="col-12 col-md-12">
                        <form @submit.prevent="submit">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            ...
                                            <label for="numero" class="form-label">Município</label>
                            ...
                            form.errors.classe_id }}</span>
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="pais_id" class="form-label">Província</label>
                                            <Select2 v-model="form.provincias_id" id="pais_id" class="col-12 col-md-12"
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.municipio.designacao ?? "",
                provincias_id: this.municipio.provincias_id ?? "",
                itemId: this.municipio.id ?? "",
            },
        };
    },
    mounted() { },
    methods: {
        ...
        submit() {
            ...
            axios
                .put(`/municipio/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
