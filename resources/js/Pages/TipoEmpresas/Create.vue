    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">CRIAR TIPO DE EMPRESA</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/tipos-empresas">Listagem</a></li>
                            <li class="breadcrumb-item active">Criar Tipo de Empresa</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-12 mb-4">
                                            ...
                                            <input type="text" id="numero" v-model="form.designacao" placeholder="Informe o tipo de empresa" class="form-control">
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post(route('tipos-empresas.store'), this.form)
                .then((response) => {
                    // this.form.reset();
