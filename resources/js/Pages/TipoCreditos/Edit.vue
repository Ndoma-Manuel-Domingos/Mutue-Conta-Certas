    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">EDITAR TIPO CRÉDITO</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/tipos-creditos">Listagem</a></li>
                            <li class="breadcrumb-item active">Editar Tipo Crédito</li>
                        </ol>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.tipo_credito.designacao ?? "",
                estado: "Activo",
                itemId: this.tipo_credito.id
            },
        };
    },
    mounted() { },
    methods: {
        submit() {
            this.$Progress.start();
            axios
                .put(`/tipos-creditos/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
