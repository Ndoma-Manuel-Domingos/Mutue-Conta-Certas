                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-4 mb-4">
                                            <label for="designacao" class="form-label">Descrição da Moeda</label>
                                        ...
                                        <div class="col-12 col-md-4 mb-4">
                                            ...
                                            <input type="text" id="pais" v-model="form.pais" class="form-control">
                                            <span class="text-danger" v-if="form.errors && form.errors.pais">{{ form.errors.pais }}</span>
                                        </div>

                                        <div class="col-12 col-md-4 mb-4">
                                            <label for="sigla" class="form-label">Sigla</label>
                                            <input type="text" id="sigla" v-model="form.sigla" class="form-control">
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.moeda.designacao ?? "",
                pais: this.moeda.pais ?? "",
                sigla: this.moeda.sigla ?? "",
                itemId: this.moeda.id,
                estado: "",
            },
    ...
    methods: {
        submit() {
            this.$Progress.start();
            axios
                .put(`/moeda/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
