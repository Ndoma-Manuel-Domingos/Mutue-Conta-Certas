...
export default {
    props: ["licencaUsuario", "usuarios", "licencas"],
    ...
    data() {
        return {
            ...
            form: {
                usuario_id: this.licencaUsuario.id_usuario ?? "",
                licenca_id: this.licencaUsuario.id_licenca ?? "",
                itemId: this.licencaUsuario.id,
            },
        };
    },
    mounted() { },
    methods: {
        ...
        submit() {
            ...
            axios
                .put(`/licenca-usuario/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
