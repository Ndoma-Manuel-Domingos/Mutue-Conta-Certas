    ...
    <MainLayoutsAdmin>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">EDITAR PAÍS</h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="designacao" class="form-label">Descrição do País</label>
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="nome_ingles" class="form-label">Descrição do País(Inglês)</label>
                                            <input type="text" id="nome_ingles" v-model="form.nome_ingles" class="form-control">
                                            <span class="text-danger" v-if="form.errors && form.errors.nome_ingles">{{ form.errors.nome_ingles }}</span>
                                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.paises.designacao ?? "",
                nome_ingles: this.paises.nome_ingles ?? "",
                itemId: this.paises.id
            },
    ...
    methods: {
        submit() {
            ...
            axios
                .put(`/paises/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
