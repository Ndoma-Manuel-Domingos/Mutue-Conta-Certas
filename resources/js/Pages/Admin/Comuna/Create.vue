    ...
    <MainLayoutsAdmin>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">CRIAR NOVO COMUNA</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/provincia">Listagem</a></li>
                            <li class="breadcrumb-item active">Criar Comuna</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12">
                        <form @submit.prevent="submit">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="numero" class="form-label">Comuna</label>
                            ...
                            form.errors.classe_id }}</span>
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="pais_id" class="form-label">Município</label>
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post(route('comuna.store'), this.form)
                .then((response) => {
