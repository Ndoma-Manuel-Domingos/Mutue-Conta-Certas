    ...
    <MainLayoutsAdmin>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">EDITAR COMUNA</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/comuna">Listagem</a></li>
                            <li class="breadcrumb-item active">Editar Comuna</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <form @submit.prevent="submit">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="numero" class="form-label">Província</label>
                            ...
                            form.errors.classe_id }}</span>
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            ...
                                            <Select2 v-model="form.municipio_id" id="pais_id" class="col-12 col-md-12"
                                                :options="municipio" :settings="{ width: '100%' }" />
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.comuna.designacao ?? "",
                municipio_id: this.comuna.municipio_id ?? "",
                itemId: this.comuna.id ?? "",
            },
        };
    },
    mounted() { },
    methods: {
        ...
        submit() {
            ...
            axios
                .put(`/comuna/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
