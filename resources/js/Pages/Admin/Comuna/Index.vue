          ...
          <div class="col-12 col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="/comuna/create" class="btn btn-info">
                  <i class="fas fa-plus"></i>NOVA COMUNA
                </a>
              </div>
...
export default {
  ...
  methods: {
    ...
    ExportarExcelComuna() {
      window.open(`exportar-comuna-excel`);
    },
    imprimirPeriodos() {
