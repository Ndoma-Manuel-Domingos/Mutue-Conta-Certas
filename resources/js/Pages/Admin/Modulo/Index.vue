    ...
    <MainLayoutsAdmin>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">LISTAGEM DE MÓDULOS</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="/modulo/create" class="btn btn-info text-uppercase"> <i class="fas fa-plus"></i>NOVO Módulos </a>
                            </div>
                            <div class="card-body table-responsive">
                                <table class="table table-bordered table-hover" id="tabela_municipios">
                                    ...
                                    <tbody>
                                        <tr v-for="item in modulos" :key="item">
                                            <td>#</td>
                                            <td>{{ item.id }}</td>
                                            <td>{{ item.designacao }}</td>
                                            <td>
                                                <div class="float-right">
                                                    <a :href="`/modulo/${item.id}/edit`"
