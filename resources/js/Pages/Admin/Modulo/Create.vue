    ...
    <MainLayoutsAdmin>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">CRIAR NOVO MÓDULO</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/modulo">Listagem</a></li>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            ...
                                            <input type="text" id="numero" v-model="form.designacao" class="form-control" placeholder="Informe o modulo">
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post(route('modulo.store'), this.form)
                .then((response) => {
                    // this.form.reset();
