                    ...
                    <div class="col-12 col-md-12">
                        <form @submit.prevent="submit">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="numero" class="form-label">Descrição do País</label>
                            ...
                            form.errors.classe_id }}</span>
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            <label for="numero" class="form-label">Descrição do País(Inglês)</label>
                                            <input type="text" id="numero" v-model="form.nome_ingles" class="form-control">
                                            <span class="text-danger" v-if="form.errors && form.errors.classe_id">{{
                            form.errors.classe_id }}</span>
                                        </div>
