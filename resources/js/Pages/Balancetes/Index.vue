                                ...
                                <form action="">
                                    <div class="row">
                                        <div class="col-12 col-md-4 mb-4">
                                            <label for="tipo_balancete_id" class="form-label">Tipo de Balancete</label>
                                            <Select2 id="tipo_balancete_id" v-model="tipo_balancete_id"
                                                :options="tipos_balancetes" :settings="{ width: '100%' }" />
                                        </div>
                        ...
                        />
                                        ...
                                        <div class="col-12 col-md-2 mb-4">
                                            ...
                                            <input type="date" id="data_inicio" v-model="data_inicio"
                                                class="form-control" :min="minDate(userYear)"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-center"
                                                v-show="tipo_balancete_id == 3 || tipo_balancete_id == 1">Dados do
                                                Período</th>
                                        ...
                                        <tr>
                                            <th class="text-left"
                                                v-show="tipo_balancete_id == 3 || tipo_balancete_id == 1">Débito</th>
                                            <th class="text-left"
                                                v-show="tipo_balancete_id == 3 || tipo_balancete_id == 1">Crébito</th>
