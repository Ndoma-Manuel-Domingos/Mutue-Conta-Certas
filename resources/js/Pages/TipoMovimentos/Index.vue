    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">LISTAGEM DE TIPOS MOVIMENTOS</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="/tipos-movimentos">Dashboard</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover" id="tabela_de_tipos_movimentos">
                                    ...
                                    <tbody>
                                        <tr v-for="item in tipos_movimentos" :key="item">
                                            <td>#</td>
                                            <td>{{ item.id }}</td>
                                            <td>{{ item.designacao }}</td>
                                            <td>
                                                <div class="float-right">
                                                    <a :href="`/tipos-movimentos/${item.id}/edit`"
...
export default {
    ...
    mounted() {
        $('#tabela_de_tipos_movimentos').DataTable({
    ...
    methods: {
        updateData() {
            this.$Progress.start();
            this.$inertia.get("/tipos-movimentos", this.params, {
                preserveState: true,
                preverseScroll: true,
                onSuccess: () => {
        ...
        ExportarExcelTipoMovimento() {
            window.open(
                `exportar-tipo-movimento-excel`
            );
        },
