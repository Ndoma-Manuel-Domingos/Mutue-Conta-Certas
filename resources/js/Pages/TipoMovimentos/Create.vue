    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">CRIAR TIPO DE MOVIMENTO</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/tipos-movimentos">Listagem</a></li>
                            <li class="breadcrumb-item active">Criar Tipo de Movimento</li>
                        </ol>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios.post(route('tipos-movimentos.store'), this.form)
                .then((response) => {
