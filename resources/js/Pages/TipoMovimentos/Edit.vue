    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-info">EDITAR TIPO DE MOVIMENTO</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/tipos-movimentos">Listagem</a></li>
                            <li class="breadcrumb-item active">Editar Tipo de Movimento</li>
                        </ol>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                designacao: this.tipo_movimento.designacao ?? "",
                itemId: this.tipo_movimento.id
            },
        };
    },
    mounted() { },
    methods: {
        submit() {
            this.$Progress.start();
            axios
                .put(`/tipos-movimentos/${this.form.itemId}`, this.form)
                .then((response) => {
                    // this.form.reset();
