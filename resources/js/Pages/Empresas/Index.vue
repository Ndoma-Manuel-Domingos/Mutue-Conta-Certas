                    ...
                    <div class="col-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="/empresas/create" class="btn btn-info btn-sm"> <i class="fas fa-plus"></i>
                                    CRIAR EMPRESA</a>
                                ...
                                <table class="table table-bordered table-hover" id="tabela_de_empresas">
                                    ...
                                    (item.moeda.alternativa ? (item.moeda.alternativa ?
                                        item.moeda.alternativa.sigla : "") : "") : "" }}</td>
                                            ...
                                            <td class="text-capitalize">{{ item.estado_empresa_id == 1 ? 'Activo' :
                                    'Desactivo' }}</td>
                                            <td>

                                                <div class="float-right">
                                                    <a :href="`/empresas-duplicar/${item.id}`"
                                                        class="btn btn-sm btn-info mx-1"><i class="far fa-copy"></i>
                                                        Duplicar</a>
                                                    ...
                                                    <a @click="mudar_estado_empresa(item)"
                                                        ...
                                                        v-if="item.estado_empresa_id == 2"><i class="fas fa-check"></i>
                                                        Activar</a>
                                                    <a @click="mudar_estado_empresa(item)"
                                                        class="btn btn-sm btn-danger mx-1" v-else><i
                                                            class="fas fa-times"></i> Desctivar</a>
                                                    <a @click="iniciar_sessao_empresa(item)"
                                                        class="btn btn-sm btn-secondary mx-1"><i class="fas fa-cog"></i>
                                                        Operar</a>
                                                    <a :href="`/licencas-escolha/${item.id}`"
                                                        class="btn btn-sm btn-secondary mx-1"
                                                        :class="item.btn"><i class="fas fa-cog"></i> Assinar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
