  ...
  <MainLayouts>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">EDITAR EXERCÍCIO</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/exercicios">Listagem</a></li>
              <li class="breadcrumb-item active">Editar Exercícios</li>
            </ol>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        designacao: this.exercicio.designacao ?? "",
        estado: this.exercicio.estado ?? "",
        itemId: this.exercicio.id ?? "",
      },
    };
  },
  mounted() {},
  methods: {
    submit() {
      this.$Progress.start();
      axios
        .put(`/exercicios/${this.form.itemId}`, this.form)
        .then((response) => {
          // this.form.reset();
