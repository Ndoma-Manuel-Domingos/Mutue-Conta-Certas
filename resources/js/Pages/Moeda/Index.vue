                    ...
                    <div class="col-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="" class="btn btn-sm mx-1 btn-success float-left" @click="ExportarExcelMoeda()">
                                    <i class="fas fa-file-excel"></i> Exportar</a>

                                <div class="card-tools">
                                    <div class="input-group input-group" style="width: 450px">
                                        <input type="text" v-model="input_busca_moedas" class="form-control float-right"
