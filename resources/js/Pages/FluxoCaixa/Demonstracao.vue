                                ...
                                <form action="">
                                    <div class="row">
                                        <div class="col-12 col-md-3 mb-4">
                                            ...
                                            <Select2 id="exercicio_id" v-model="exercicio_id" :options="exercicios"
                                                :settings="{ width: '100%' }" />
                                        </div>
                                        ...
                                        <div class="col-12 col-md-3 mb-4">
                                            ...
                                            <input type="date" id="data_final" v-model="data_final" class="form-control"
                                                placeholder="Ex: 1.1, 1.1.1" :min="minDate(userYear)"
                                                :max="maxDate(userYear)" />
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="" class="btn btn-sm mx-1 btn-success float-right"
                                    @click="ExportarExcelDemonstracao()">
                                    <i class="fas fa-file-excel"></i> Exportar</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered table-hover" id="tabela_de_diarias2">
                                    <thead>
                                        <tr>
                                            <th>Descrição</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=clientes"
                                                    class="text-info">Dinheiro recebido de Clientes</a></td>
                                            <td class="text-right">{{ formatarValorMonetario(dinheiro_recebido_clientes)
                                                }}</td>
                                        </tr>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=mercadorias"
                                                    class="text-info">Dinheiro pagos em mercadorias</a></td>
                                            <td class="text-right">{{
                                                formatarValorMonetario(dinheiro_recebido_fornecedores) }}</td>
                                        </tr>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=operacionais"
                                                    class="text-info">Dinheiro pagos em salários e custos
                                                    operacionais</a></td>
                                            <td class="text-right">{{ formatarValorMonetario(dinheiro_custo) }}</td>
                                        </tr>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=jursos"
                                                    class="text-info">Dinheiro pagos em juros</a></td>
                                            <td class="text-right">{{ formatarValorMonetario(dinheiro_pagos_juros) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=imposto"
                                                    class="text-info">Dinheiro pagos em impostos</a></td>
                                            <td class="text-right">{{ formatarValorMonetario(dinheiro_imposto) }}</td>
                                        </tr>
                                        <tr>
                                            <td><a href="/demonstracao-fluxo-caixa-detalhe?demonstracao=outros"
                                                    class="text-info">Outros</a></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">{{ formatarValorMonetario(dinheiro_recebido_clientes
                                                + dinheiro_recebido_fornecedores + dinheiro_custo + dinheiro_pagos_juros
                                                + dinheiro_imposto + outros) }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
