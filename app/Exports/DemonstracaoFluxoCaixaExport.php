...
class DemonstracaoFluxoCaixaExport extends DefaultValueBinder implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping, WithEvents, WithDrawings, WithCustomStartCell
{
    /**
    * @return \Illuminate\Support\Collection
    */
    public $dadosEmpresa, $demonstracao, $data_inicio, $data_final, $exercicio_id, $periodo;
    ...
    {
        return MovimentoItem::with(['empresa', 'diario'])->where('empresa_id', $this->empresaLogada())->get();
    }
