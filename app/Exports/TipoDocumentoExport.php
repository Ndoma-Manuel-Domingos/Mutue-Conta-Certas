...
class TipoDocumentoExport extends DefaultValueBinder implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping, WithEvents, WithDrawings, WithCustomStartCell
{
    /**
    ...
    */
    ...
    {
        return TipoDocumento::with(['empresa', 'diario'])->where('empresa_id', $this->empresaLogada())->get();
    }
