...
class TipoProveitoExport extends DefaultValueBinder implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping, WithEvents, WithDrawings, WithCustomStartCell
{
    /**
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('TIPO DE PROVEITO');
    ...
    {
        $sheet->setCellValue('D5', strtoupper('TIPO DE PROVEITO'));
