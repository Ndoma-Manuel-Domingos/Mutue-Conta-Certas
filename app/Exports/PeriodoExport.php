...
class PeriodoExport extends DefaultValueBinder implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithMapping, WithEvents, WithDrawings, WithCustomStartCell
{
    /**
    ...
    */
    ...
    public function map($data): array
    {
        ...
        return [
            ...
            $data->estado == 'activo' ? 'Activo' : 'Desactivo',
    ...
    {
        return Periodo::with(['empresa', 'exercicio'])->get();
    }
